...
export const sidenavMenuItems = [
    ...
    new SidenavMenu (2, 'Local Information', null, null, null, true, 0),
    new SidenavMenu (10, 'Business', null, null, null, true, 2),
    ...
    new SidenavMenu (50, 'About Us', '/products/jewellery', null, null, false, 0),
    new SidenavMenu (51, 'Places To Stay', '/products/electronics', null, null, false, 0),
    new SidenavMenu (52, 'Eat & Drink', '/products/sports', null, null, false, 0),
